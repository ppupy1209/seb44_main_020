...
// function Starrate(){
//     // const arr=[0.5,1,1.5,2,2.5,3,3.5,4,4.5,5];
//     const arr=[5,4.5,4,3.5,3,2.5,2,1.5,1,0.5];
...
//             {arr.map((i) => {
//           if (i % 1 === 0) {
//             return <RightStar onClick={()=>handleClick(i)} key={i}  isClicked={i<=clickedStars}/>;
//           } else {
//             return <LeftStar onClick={()=>handleClick(i)} key={i}  isClicked={i<=clickedStars} />;
//           }
//         })}
//             </S.StarArr>
//         </S.Starrating>
...
function Starrate(){
    ...
    const stars=arr.map((i)=>{
        if(i%1===0){
            return <LeftStar key={i} />
        }
        else{
            return <RightStar key={i} />
        }
    }
    )
    return(
...
// function LeftStar({onClick,}:Props){
//     return(
//         <div onClick={onClick}>
